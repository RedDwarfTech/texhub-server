...
use crate::model::{
    app::app_context::AppContext, diesel::tex::custom_tex_models::{TexProjFolder, TexProject}, request::project::query::{
        proj_list_query_params::ProjListQueryParams, proj_query_params::ProjQueryParams,
    }, response::project::tex_proj_resp::TexProjResp
};

pub trait ProjSpec<'a> {
    fn new(context: Option<&'a AppContext>) -> Self where Self: Sized;
