...
pub fn config(cfg: &mut web::ServiceConfig) {
    ...
    .service(web::scope("/tex/project/figure").route("/upload", web::post().to(upload_full_proj)));
    cfg.app_data(
        MultipartFormConfig::default()
    ...
    .service(web::scope("/tex/project/proj").route("/upload", web::post().to(upload_proj_file)));
}
